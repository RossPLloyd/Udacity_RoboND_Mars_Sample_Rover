...
class RoverState():
    def __init__(self):
        ...
        self.pos = [None, None] # Current position (x, y)
        ...
        self.count = 0 # adding a timstep counter, experimented with using as part of 'stuck' routine
        self.buffer_xypos = [] #initializes a list to store the position data
        self.xypos_mult = None # initializes the absoluted product of x and y position
